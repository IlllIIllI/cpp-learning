...
const char descriptor_table_protodef_person_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "(\005\022\014\n\004name\030\021 \001(\t\022\022\n\005email\030\022 \001(\tH\000\210\001\001B\010\n\006"
    "_emailb\006proto3"
};
...
::uint8_t* PROTOBUF_NONNULL Person::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "test.Person.email");
